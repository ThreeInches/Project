					...
					<tbody class="text-center">
						...
						<c:forEach var="u" items="${allUser }">
							<tr>
								...
								<td>${u.cname }</td>
								<td>${u.tel }</td>
								<td><a href="handle/deletecustom?cid=${u.cid}">delete</a></td>
								<td><a href="updatecustom">修改客户电话</a></td>
							</tr>
						</c:forEach>
						
						<tr>
							<td colspan="5">欢迎${sessionScope.myuser.uname }</td>
						</tr>
						<tr>
							<td colspan="5" align="right">
								<ul class="pagination">
									...
									<c:if test="${currentPage != 1}">
										<li><a href="handle/selectAllCustomByPage?currentPage=${currentPage-1}">上一页</a></li>
									</c:if>
									<c:if test="${currentPage != totalPage}">
										<li><a href="handle/selectAllCustomByPage?currentPage=${currentPage+1}">下一页</a></li>
									</c:if>
								</ul>
							</td>
						</tr>
						<td><a href=insertcustom>添加客户</a></td>
