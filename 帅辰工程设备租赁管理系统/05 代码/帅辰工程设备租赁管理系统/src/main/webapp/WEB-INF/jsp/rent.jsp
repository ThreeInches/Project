			...
			<div class="table table-responsive">
				<table class="table table-bordered table-hover">
					<tbody class="text-center">
						...
						<tr>
							<td colspan="10">欢迎${sessionScope.myuser.uname }</td>
						</tr>
						<tr>
							<td colspan="10" align="right">
								<ul class="pagination">
									...
									<c:if test="${currentPage != 1}">
										<li><a href="handle/selectAllRentByPage?currentPage=${currentPage-1}">上一页</a></li>
									</c:if>
									<c:if test="${currentPage != totalPage}">
										<li><a href="handle/selectAllRentByPage?currentPage=${currentPage+1}">下一页</a></li>
									</c:if>
								</ul>
							</td>
						</tr>
					</tbody>
					<td><a href=insertrent>添加订单</a></td>
					<td><a href=updaterent>修改租赁总价</a></td>
