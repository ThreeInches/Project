							...
							<td colspan="4" align="right">
								<ul class="pagination">
									...
									<c:if test="${currentPage != 1}">
										<li><a href="handle/selectAllRepairByPage?currentPage=${currentPage-1}">上一页</a></li>
									</c:if>
									<c:if test="${currentPage != totalPage}">
										<li><a href="handle/selectAllRepairByPage?currentPage=${currentPage+1}">下一页</a></li>
									</c:if>
								</ul>
							</td>
						</tr>
					</tbody>
					<td><a href=insertrepair>添加订单</a></td>
